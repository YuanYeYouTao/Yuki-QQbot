...
| `CONVERSATION_ROLLUP_RAW_TAIL_EVENTS` | `32` |
| `CONVERSATION_ROLLUP_RAW_TAIL_CHARACTERS` | `1600` |
| `CONVERSATION_ROLLUP_TRIGGER_EVENTS` / `STOP_EVENTS` | `64` / `16` |
| `CONVERSATION_ROLLUP_TRIGGER_CHARACTERS` / `STOP_CHARACTERS` | `8000` / `2000` |
